      ...
      <div class="form-inner">
          ...
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="shipinmingcheng" name="shipinmingcheng" placeholder="请输入视频名称" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="shipinleixing" name="shipinleixing" placeholder="请输入视频类型" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>

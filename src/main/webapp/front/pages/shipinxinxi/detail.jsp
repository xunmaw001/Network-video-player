				...
				<div class="layui-row">
					<div class="layui-tab layui-tab-card">
						...
						<div class="layui-tab-content">
								...
								<div v-html="detail.shipinxiangqing"></div>
							</div>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`shipinxinxi`);

...
<body>
    ...
    <div class="plate">
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in shipinxinxiRecommend" v-bind:key="index">
                <a target="_self" :href="'../shipinxinxi/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.fengmian?item.fengmian.split(',')[0]:''" width="385" height="220" />
                  </div>
                  <div class="remark">
                    <h5>{{item.shipinmingcheng}}</h5>
                  </div>
                </a>
              </li>
            </ul>
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in shipinxinxiList" v-bind:key="index">
                <a target="_self" :href="'../shipinxinxi/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.fengmian?item.fengmian.split(',')[0]:''" width="385" height="220" />
                  </div>
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`shipinxinxi/autoSort`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.shipinxinxiRecommend = res.data.list;
      });

      http.request(`shipinxinxi/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.shipinxinxiList = res.data.list;
      });
    });
  </script>
</body>
